<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <a href="shop.php"> <i class="fas fa-angle-right"></i> flooring</a>
      </div>
      ...
      <div class="box">
         ...
         <a href="shop.php"> <i class="fas fa-angle-right"></i> furniture</a>
      </div>
      ...
      <div class="box">
         ...
         <a href="mailto:shaikh@gmail.com"><i class="fas fa-envelope"></i> thetimberfactory@gmail.com</a>
         <a href="https://www.google.com/myplace"><i class="fas fa-map-marker-alt"></i> mangalore, karnataka,<br> india - 575001</a>
      </div>
